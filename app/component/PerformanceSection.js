...
const PerformanceSection = () => {
  return (
    <>
      <div className="bg-[#CFCFCF] flex flex-col-reverse md:flex-row items-center md:p-0 p- mx-[3%] rounded-2xl">
        <div className="md:w-1/2 m-20 w-full px-5">
          ...
          <div className="flex items-center ">
            <div className="flex flex-col">
              <img
                src="images\d4e01d96bc838f08c10c2fb6560948d3881ebdec.png"
                alt=""
      ...
      <div className="relative md:w-1/2 w-[95%] h-[75vh] top-[35px]">
        <img src="images\Rectangle 28 (1).png" alt="" className="absolute w-[80%] "/>
        <img src="images\Rectangle 28.png" alt=""  className="absolute  w-[80%] top-[5%] left-[5%]" />
        <img src="\images\Rectangle 29.png" alt="" className="absolute w-[80%] top-[10%] left-[10%]"/>
     </div>
      </div>
    
      <section className="flex flex-col md:flex-row  justify-center gap-[8%] my-20 mx-[2%]">
